	...
	F.Filtering = F.Component.extend(/** @lends FooTable.Filtering */{
		...
		$create: function () {
			...
			var $form_grp = $('<div/>', {'class': 'form-group footable-filtering-search'})
					/** 엑셀다운로드 버튼 */
					.append("<a href='javascript:void();' id='excelBtn'><img src='/img/btn_download.png' style='width:20px; height: 18px; vertical-align:middle; margin-right:10px;'/></a>")
			...
			self.$button = $('<button/>', {type: 'button', 'class': 'btn btn-primary'})
				...
				.append("<img src='/img/mag_trans.png' style='width:15px; height:15px; vertical-align:text-top;'/>");				
